...
sub main::generate($$) {
   ...
   print ' *******************************************************************************/', "\n";
   print "\n";
   print '#define BITFIELD(byte, mask, shift) \\', "\n";
   print '   (((byte) & (mask)) >> (shift))', "\n";
   print "\n";
   print '/* Protocol version */', "\n";
   print '#define RTP_VERSION(byte) BITFIELD(byte, 0xC0, 6)', "\n";
   print "\n";
   print '/* Payload type */', "\n";
   print '#define RTP_PAYLOAD_TYPE(byte) BITFIELD(byte, 0xFF, 0)', "\n";
   print "\n";
   print '#define RTP_MIN_SIZE 12', "\n";
   print '#define RTP_CURRENT_VERSION 2', "\n";
   print '#define G729 18', "\n";
   print '#define G711U 0', "\n";
   print '#define PAYLOAD_LENGTH 172 // RTP Header + Audio data', "\n";
   print "\n";
   print "\n";
