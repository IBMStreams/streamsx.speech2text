...
SAB_FILE=output/com.ibm.streamsx.speech2text.callcenter.test.transcripts.singlechannel.TestSingleChannelTranscriptBuilder/BuildConfig/com.ibm.streamsx.speech2text.callcenter.test.transcripts.singlechannel.TestSingleChannelTranscriptBuilder.sab
# Modify the job name to the desired one 
JOB_NAME=TestSingleChannelTranscripts
